      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">           
            ...
            <li class="active"><a href="../earrings.php">Earrings</a></li>
...
<ul>
		...
		<li>
			<img src="../../Images/Earrings/12.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../../Images/Earrings/13.png"/>
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../../Images/Earrings/25.png"/>
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
		</div>
        </li>
         <li>
			<img src="../../Images/Earrings/27.png"/>
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
		</div>
        </li>
  ...
  <div class="colors">
  <a href="../earrings.php"><h3>Colors</h3>
  </div>
