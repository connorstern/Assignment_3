...
<h1>Earrings </h1>
<div id="page">
Pages <a href="bracelets.php">1</a> <a href="earrings2.php">2</a> <a href="earrings3.php">3</a>
</div>
<div id="content">
<div id="pictures">
<div id="lightbox">
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/1.png"/>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/2.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/3.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/4.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/5.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/6.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/7.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/8.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/9.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/10.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/11.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/12.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
