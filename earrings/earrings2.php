...
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/13.png"/>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/14.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/15.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/16.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/17.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/18.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/19.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/20.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/21.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/22.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/23.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
          <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Earrings/24.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
