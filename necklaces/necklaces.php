...
Pages
  ...
  <li><a href="necklace2.php">2</a></li>
...
<ul>
    	<li>
			<img src="../Images/Necklaces/1.png" width="100%" height="100%" />
		...
		<li>
			<img src="../Images/Necklaces/2.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Necklaces/3.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Necklaces/4.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Necklaces/5.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
           <li>
			<img src="../Images/Necklaces/6.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
