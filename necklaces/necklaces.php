...
<h1>Necklaces </h1>
<div id="page">
Pages <a href="necklaces.php">1</a> <a href="necklace2.php">2</a>
</div>
<div id="content">
<div id="pictures">
<div id="lightbox">
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/1.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
       <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/2.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/3.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/4.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
      <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/5.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/6.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/7.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
       <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/8.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
