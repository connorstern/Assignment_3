...
<ol class="breadcrumb">
Pages
  <li><a href="necklaces.php">1</a></li>
  <li class="active">2</a></li>
  <li><a href="necklace3.php">3</a></li>
...
<ul>
    	<li>
			<img src="../Images/Necklaces/7.png" width="100%" height="100%" />
		...
		<li>
			<img src="../Images/Necklaces/8.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Necklaces/9.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Necklaces/10.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Necklaces/11.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
           <li>
			<img src="../Images/Necklaces/12.png" width="100%" height="100%" />
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
