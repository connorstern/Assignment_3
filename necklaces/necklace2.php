...
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/9.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
       <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/10.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/11.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
        <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/12.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
      <li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/13.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		...
		<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Necklaces/14.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
