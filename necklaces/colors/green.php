      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="necklaces/necklaces.php">Necklaces</a></li>
...
<ul>
		...
		<li>
			<img src="../../Images/Necklaces/2.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../../Images/Necklaces/12.png"/>
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../../Images/Necklaces/13.png"/>
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
		</div>
        </li>
