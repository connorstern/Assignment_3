...
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../../Images/Bracelets/2.png"/>
		...
		<li>
			<img src="../../Images/Bracelets/10.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../../Images/Bracelets/11.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
		</div>
        </li>
         <li>
			<img src="../../Images/Bracelets/12.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
		</div>
        </li>
