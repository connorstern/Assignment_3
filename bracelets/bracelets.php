...
<ul>
    	<li>
			<a href="Checkout/bracelet1.php"><img src="../Images/Bracelets/1.png"/>
		...
		<li>
			<img src="../Images/Bracelets/2.png"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Bracelets/3.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/4.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/5.png"/>
			<div class="image_title">
		...
		<li>
			<img src="../Images/Bracelets/6.png"/>
			<div class="image_title">
				<h5 class="title">Looking Down</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Bracelets/7.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/8.png">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/9.png"/>
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
