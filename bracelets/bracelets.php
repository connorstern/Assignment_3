...
Pages
  ...
  <li><a href="bracelets2.php">2</a></li>
  <li><a href="bracelets3.php">3</li>
</ol>
</div>
<div id="content">
<div class="row">
...
<ul>
		...
		<li>
			<img src="../Images/Bracelets/2.png" width="100%" height="100%"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Bracelets/3.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/4.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/5.png" width="100%" height="100%"/>
			<div class="image_title">
		...
		<li>
			<img src="../Images/Bracelets/6.png" width="100%" height="100%"/>
			<div class="image_title">
				<h5 class="title">Looking Down</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Bracelets/7.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/8.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/9.png" width="100%" height="100%"/>
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
