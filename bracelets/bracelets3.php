...
<ol class="breadcrumb">
Pages
  <li><a href="bracelets.php">1</a></li>
...
<ul>     
		...
		<li>
			<img src="../Images/Bracelets/20.png" width="100%" height="100%"/>
			<div class="image_title">
				<h5 class="title">$40.00</h5>
			</div>
		</li>
		<li>
			<img src="../Images/Bracelets/21.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/22.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/23.png" width="100%" height="100%"/>
			<div class="image_title">
        ...
        <li>
			<img src="../Images/Bracelets/26.png" width="100%" height="100%">
			<div class="image_title">
				<h5 class="title">Skipping Rocks</h5>
			</div>
		</li>
        <li>
			<img src="../Images/Bracelets/27.png" width="100%" height="100%"/>
			<div class="image_title">
				<h5 class="title">Walking Up</h5>
			</div>
		</li>
